...
module.exports = class ColumnType {
    ...
    static get Increments() {return Increments}
    static get Text() {return Text}
    static get BigInteger() {return BigInteger}
    ...
    static get All() {return [Integer, String, Increments, Text, BigInteger, Float, Boolean, Date, DateTime, Time, Timestamp]}
}